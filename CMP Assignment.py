...
class BankAccount:
    SAVINGS_LIMIT = 100000  # Savings account limit

    def _init_(self, account_number, account_type, balance=0.0):
    ...
    def deposit(self, amount):
        ...
        if self.account_type == "savings" and self.balance + amount > self.SAVINGS_LIMIT:
            print(f"Deposit amount exceeds the savings account limit of {self.SAVINGS_LIMIT}.")
            return
    ...
    def _save_account_data(self):
        ...
        file_name = f"{self.account_number}.dat"
    ...
    class BankAppGUI:
        def _init_(self, root):
            ...
            self.background_color = "light green"
...
def load_account(account_number):
    file_name = f"{account_number}.dat"
    ...
    with open(file_name, 'rb') as file:
        ...
        return BankAccount(account_data['account_number'], account_data['account_type'], account_data['balance'])
    def create_a
